-- Expand storefront RPCs for display parity with Inventory
-- Appends 8 fields to RETURNS TABLE and SELECT list:
-- inventory_items: condition, is_graded, grading_company, grade (smallint)
-- catalog_products: kind, language_code, rarity, set_name_en
