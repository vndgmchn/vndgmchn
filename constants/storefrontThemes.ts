export type StorefrontTheme = {
  id: string;
  name: string;
  cardBackground: string | null; // null means use theme.surface
  textPrimary: string | null;    // null means use theme.text
  textSecondary: string | null;  // null means use theme.mutedText
  buttonSurface: string | null;  // null means use theme.text (primary) or background (secondary)
