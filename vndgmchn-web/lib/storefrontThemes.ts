export type StorefrontTheme = {
  id: string;
  name: string;
  cardBackground: string | null; // null means use default surface
  textPrimary: string | null;    // null means use default text
  textSecondary: string | null;  // null means use default mutedText
  buttonSurface: string | null;  // null means use default primary button
  buttonText: string | null;     // null means use #fff
};

/**
 * NOTE: Keep this file in sync with constants/storefrontThemes.ts in the root directory.
 */
